...
// Здравствуйте! Здесь, конечно, пришлось поломать голову, но за неимением времени
// получилось только так. Не разобрался, почему для квадратных матриц условие только <
// а для разноразмерных <= Буду рад, если поможете разобраться и подсказать,
// можно ли было решить короче. Заранее благодарю!